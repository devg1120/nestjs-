...
import { UserCreateWithoutPostsInput } from './user-create-without-posts.input.js';
import { Type } from 'class-transformer';
import { UserCreateOrConnectWithoutPostsInput } from './user-create-or-connect-without-posts.input.js';
import { UserUpsertWithoutPostsInput } from './user-upsert-without-posts.input.js';
import { UserWhereInput } from './user-where.input.js';
//import { Prisma } from '@prisma/client';
import { UserWhereUniqueInput } from './user-where-unique.input.js';
import { UserUpdateToOneWithWhereWithoutPostsInput } from './user-update-to-one-with-where-without-posts.input.js';
